...
export default function RegisterItem() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    // Aqui você faria a requisição para o backend para registrar o item
    console.log("Item registrado:", { itemName, code });
  ...
  return (
    ...
    >
      <div className="flex flex-col border-2 border-gray-200 rounded-lg p-6 w-full max-w-lg shadow-2xl bg-white">
